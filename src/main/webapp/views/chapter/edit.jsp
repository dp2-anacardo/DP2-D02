...
<spring:message code="chapter.firstMessage" />
<form:form action="chapter/chapter/edit.do" modelAttribute="chapter">

	<form:hidden path="id" />
 
	<form:label path="name">
		<spring:message code="chapter.name" />
	</form:label>
	...
	<form:label path="email">
		<spring:message code="chapter.email" />
	</form:label>
	...
	<form:label path="phoneNumber">
		<spring:message code="chapter.phoneNumber" />
	</form:label>
	...
	<form:label path="address">
		<spring:message code="chapter.address" />
	</form:label>
	...
	<input type="button" name="back"
		value="<spring:message code="chapter.back" />"
